        ...
        <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          ...
          >
            <p className="text-lg text-muted-foreground">
              I&apos;m a full-stack developer with over 2 years of experience building fast, scalable, and reliable web applications. I focus on well-structured architectures that ensure efficiency and seamless user experiences.
            </p>
